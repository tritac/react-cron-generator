...
const DailyCron = (props) => {
    ...
    const onDayChange = (e) => {
        if (!e.target.value ||
            (parseInt(e.target.value) > 0 && parseInt(e.target.value) < 32)) {
    ...
    return (jsxs("div", Object.assign({ className: 'd-flex' }, { children: [jsxs("div", Object.assign({ className: ' well-small d-flex align-items-center' }, { children: [jsx("input", { type: 'radio', onChange: (e) => {
                            setState(Object.assign(Object.assign({}, state), { every: true }));
                            props.onChange();
                        }, value: '1', name: 'DailyRadio', checked: state.every }), jsx("span", { children: translateFn('Every') }), jsx("input", { disabled: !state.every, type: 'Number', maxLength: 2, onChange: onDayChange, value: props.value[3].split('/')[1] ? props.value[3].split('/')[1] : '' }), jsx("span", { children: translateFn('day(s)') })] })), jsxs("div", Object.assign({ className: ' well-small d-flex align-items-center ' }, { children: [jsx("input", { onChange: (e) => {
                        ...
                        }, type: 'radio', value: '2', name: 'DailyRadio', checked: !state.every }), jsx("span", { children: translateFn('Every week day') })] })), jsx("span", { children: translateFn('at') }), jsx(HourSelect, { onChange: onAtHourChange, value: props.value[2] }), jsx(MinutesSelect, { onChange: onAtMinuteChange, value: props.value[1] })] })));
};
...
const Cron = (props) => {
    ...
    const getHeaders = () => {
        return (jsx("select", Object.assign({ className: 'form-select', onChange: (e) => { var _a; return tabChanged((_a = e.target) === null || _a === void 0 ? void 0 : _a.value); } }, { children: state.headers.map((d, index) => {
                return (jsx("option", Object.assign({ value: d, selected: state.selectedTab === d }, { children: translate(d) }), index));
            }) })));
    };
    ...
    return (jsxs("div", Object.assign({ className: ' ' }, { children: [jsxs("div", Object.assign({ className: '' }, { children: [jsx("div", { children: getHeaders() }), jsx("div", Object.assign({ className: 'cron_builder_bordering' }, { children: state.selectedTab
                            ? getComponent(state.selectedTab)
                            : 'Select a header' }))] })), props.showResultText && jsx("div", Object.assign({ className: '' }, { children: getVal() })), props.showResultCron && (jsx("div", Object.assign({ className: 'cron-builder-bg' }, { children: state.value.toString().replace(/,/g, ' ').replace(/!/g, ',') })))] })));
};
